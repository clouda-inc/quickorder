...
- Fix download file missing data issue.
...
- Increased stock availability request timeout to handle JDE delay
...
- Changed excel template header column text color and background color
